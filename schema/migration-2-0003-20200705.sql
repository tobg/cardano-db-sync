...
BEGIN
  ...
  IF next_version = 3 THEN
    ...
    EXECUTE 'ALTER TABLE "meta" ALTER COLUMN "protocol_const" TYPE NUMERIC(20,0)' ;
    EXECUTE 'ALTER TABLE "meta" ALTER COLUMN "slot_duration" TYPE NUMERIC(20,0)' ;
    EXECUTE 'ALTER TABLE "meta" ALTER COLUMN "slots_per_epoch" TYPE NUMERIC(20,0)' ;
    ...
    EXECUTE 'CREATe TABLE "pool"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash" hash28type NOT NULL,"pledge" NUMERIC(20,0) NOT NULL,"reward_addr_id" INT8 NOT NULL,"meta" INT8 NULL,"margin" DOUBLE PRECISION NOT NULL,"fixed_cost" NUMERIC(20,0) NOT NULL,"registered_tx_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "pool_retire"("id" SERIAL8  PRIMARY KEY UNIQUE,"pool_id" INT8 NOT NULL,"announced_tx_id" INT8 NOT NULL,"retiring_epoch" NUMERIC(20,0) NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "central_funds"("id" SERIAL8  PRIMARY KEY UNIQUE,"epoch_no" NUMERIC(20,0) NOT NULL,"treasury" lovelace NOT NULL,"reserves" lovelace NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "param_update"("id" SERIAL8  PRIMARY KEY UNIQUE,"epoch_no" NUMERIC(20,0) NOT NULL,"min_fee" NUMERIC(20,0) NOT NULL,"max_fee" NUMERIC(20,0) NOT NULL,"max_block_size" NUMERIC(20,0) NOT NULL,"max_tx_size" NUMERIC(20,0) NOT NULL,"max_bh_size" NUMERIC(20,0) NOT NULL,"key_deposit" lovelace NOT NULL,"pool_deposit" lovelace NOT NULL,"max_epoch" NUMERIC(20,0) NOT NULL,"n_optimal" NUMERIC(20,0) NOT NULL,"influence" DOUBLE PRECISION NOT NULL,"monetary_expand_rate" interval NOT NULL,"treasury_growth_rate" interval NOT NULL,"active_slot_coeff" interval NOT NULL,"decentralisation" interval NOT NULL,"entropy" hash32type NOT NULL,"protocol_version" BYTEA NOT NULL,"min_coin" lovelace NOT NULL)' ;
